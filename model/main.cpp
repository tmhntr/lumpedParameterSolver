...
//    modules.push_back(pulm);
    ...
    body[6] = new RCR("Abd. Vena Cava", {"Q_inf"}, {"P_kid2", "P_spl2", "P_ll2", "P_abd"}, {"Q_kid2", "Q_spl2", "Q_ll2"}, {"P_abd"}, {0.3, 0.18, 0.3, 25.0});
...
//    cout << argc << endl;
    double y0[] = {2.0, 20.0, 1.0, 10.0, 1.0, 3.0, 8.0, 13.0, 90.0, 45.0, 45.0, 45.0, 45.0, 7.0, 7.0, 7.0, 30.0, 15.0};
//    double y0[] = {2.0, 20.0};
    double reltol = 1e-6;

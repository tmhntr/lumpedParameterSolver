...
public:
    heart(std::vector<std::string> inputNames, std::vector<std::string> algebraicNames, std::vector<std::string> outputNames, std::vector<double> parameters) : component_model("heart", inputNames, algebraicNames, outputNames, parameters) {  }

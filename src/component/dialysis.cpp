...
void dialysis::updateDerived(double t, double y[])
{
    ...
    // % 2008 eq. 24
    double c_u_ex = M_u_ex / V_ex; /* double c_u_pl     = c_u_ex  ; */
    double c_u_is = c_u_ex;
    double c_na_ex = M_na_ex / V_ex; /* double c_na_pl    = c_na_ex ; */
    double c_na_is = c_na_ex;
    double c_k_ex = M_k_ex / V_ex; /* double c_k_pl     = c_k_ex  ; */
    double c_k_is = c_k_ex;
    double c_cl_ex = M_cl_ex / V_ex; // double c_cl_pl    = c_cl_ex ; double c_cl_is     = c_cl_ex;
    double c_hco3_ex = M_hco3_ex / V_ex;
    double c_hco3_pl = c_hco3_ex;
    double c_hco3_is = c_hco3_ex;
    double c_h_ex = M_h_ex / V_ex;
    double c_h_pl = c_h_ex;
    double c_h_is = c_h_ex;
    double c_p_ex = M_p_ex / V_ex;
    double c_p_pl = c_p_ex;
    double c_p_is = c_p_ex;
    ...
    double R_hco3_ex = R_hco3_pl + R_hco3_is;
    double R_p_ex = R_p_pl + R_p_is;
    double R_h_ex = R_h_pl + R_h_is;
    // %
